 ...
 * migrate plugin. So there are four types of plugins in the migration
 * process: migration, source, process and destination.
 *
 * @section sec_migrations migrate plugins
 * migrate plugin definitions are stored in a module's 'migrations' directory.
 ...
 * \Drupal\migrate\Plugin\migrate, with interface
 * \Drupal\migrate\Plugin\MigrationInterface. migrate plugins are managed by
 * the \Drupal\migrate\Plugin\MigrationPluginManager class. migrate plugins
 ...
 * module that defines them. migrate source plugins are managed by the
 ...
 * migrate process plugins implement
 ...
 * module that defines them. migrate process plugins are managed by the
 ...
 * migrate destination plugins implement
 ...
 * namespace of the module that defines them. migrate destination plugins
 ...
 * @link https://www.drupal.org/node/2127611 migrate API documentation. @endlink
 *
 * @see update_api
 * @}
 */
