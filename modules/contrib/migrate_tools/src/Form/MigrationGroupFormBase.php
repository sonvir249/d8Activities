...
class MigrationGroupFormBase extends EntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status == SAVED_UPDATED) {
      ...
      drupal_set_message($this->t('migrate group %label has been updated.', ['%label' => $migration_group->label()]));
    }
    else {
      // If we created a new entity...
      drupal_set_message($this->t('migrate group %label has been added.', ['%label' => $migration_group->label()]));
    }
