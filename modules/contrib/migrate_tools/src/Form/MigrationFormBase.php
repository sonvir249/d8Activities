...
class MigrationFormBase extends EntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status == SAVED_UPDATED) {
      ...
      drupal_set_message($this->t('migrate %label has been updated.', ['%label' => $migration->label()]));
    }
    else {
      // If we created a new entity...
      drupal_set_message($this->t('migrate %label has been added.', ['%label' => $migration->label()]));
    }
